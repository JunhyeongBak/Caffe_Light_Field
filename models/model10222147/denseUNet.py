...
def denseUNet_train(script_path=None, data_path=None, tot=1, sai=25, shift_val=0.7, batch_size=1):
    ...
    n.predict = slice_warp(n.shift, n.flow_h, n.flow_v, sai)
...
if __name__ == "__main__":
    ...
    denseUNet_train(script_path=TRAIN_PATH, data_path=TRAINSET_PATH, tot=TRAIN_TOT, sai=SAI, batch_size=8, shift_val=SHIFT_VAL)
