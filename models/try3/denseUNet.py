...
def denseUNet(input, batch_size):
    def flow_layer(bottom=None, nout=1):
        flow = L.Convolution(bottom, num_output=nout, kernel_size=3, stride=1, dilation=1, pad=1,
    ...
    deconv3 = upsample_concat_layer(deconv2, conv2, 32, 128)
    deconv3 = conv_conv_group_layer(deconv3, 32)
    deconv4 = upsample_concat_layer(deconv3, conv1, 16, 256)
    deconv4 = conv_conv_group_layer(deconv4, 1)
